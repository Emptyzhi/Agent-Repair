"""Score an OpenCompass prediction with GTA-2 GPTEvaluator and Responses backend."""
...
def main() -> None:
    ...
    pack = {
        "schema_version": "gta2_responses_prediction_pack_v1",
    ...
    result = run_responses_pack_score(pack_path, args.out.resolve(), run_path, args.model)
    summary = {
        "task_id": args.task_id,
